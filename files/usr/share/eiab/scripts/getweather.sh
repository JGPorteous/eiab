#!/bin/bash
cd /home/svxlink/scripts/weather rm weather.xml -f wget -O weather.json 
"http://api.openweathermap.org/data/2.5/weather?id=957655&APPID=dad8f34bb49d6e3ba1b63200028689d5&mode=json&units=metric"
#wget -O weather.xml 
