...
menu:main:--- Echolink-In-A-Box by ZS6JGP - Setup Menu ---
        ...
        nop
        exec:Install _Dependencies:edit,pause:/opt/eiab/scripts/install.dependencies.sh
        exec:Install _SvxLink:edit,pause:/opt/eiab/scripts/install.svxlink.sh
        exec:Install SvxLink _Google TTS:edit,pause:/opt/eiab/scripts/install.svxlink-google-tts.sh
        nop
